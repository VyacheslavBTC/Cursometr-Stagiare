//
//  SubscribedQuotationsTableViewController.swift
//  Cursometr
//
//  Created by test on 24.07.17.
...
class SubscribedQuotationsTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.tableView.backgroundColor = UIColor(red: 36/255, green: 37/255, blue: 43/255, alpha: 1)
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "quotationCell", for: indexPath) as? QuotationSubscribeTableViewCell
